...
public class VistaFormulario extends javax.swing.JFrame {
    ...
    public VistaFormulario() {
        ...
        // Boton por defecto
        getRootPane().setDefaultButton(botonInsertar);
    ...
    private void initComponents() {
        ...
        botonInsertar.setToolTipText("Pulse para insertar los campos");
        ...
        panelFondo.add(botonInsertar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 250, -1, -1));
        ...
        panelFondo.add(panelVolver, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, -1, -1));
    ...
    /**
     * ActionPerformed que recoge los datos de los textfields y llama al metodo de insertar monitor
     * @param evt 
     */
    private void botonInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInsertarActionPerformed
        ...
        if (nombre.isEmpty() || apellidos.isEmpty() || actividad.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Complete todos los campos", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        monitoresController.registrarMonitor(nombre, apellidos, actividad);
        JOptionPane.showMessageDialog(null, "Monitor insertado con éxito");
